...
my_cur2.execute("select direct_url, price, size_list, upsell_product_desc from catalog_for_website where color_or_style = '" + option + "';")
df3 = pandas.DataFrame(my_cur2.fetchall())
streamlit.write(df3)
